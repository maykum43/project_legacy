...
<html lang="en">
  <head>
    ...
    <!-- End layout styles -->
    <link rel="shortcut icon" href="{{asset('/assets/images/logo/L-putih.ico')}}" />
  </head>
  <body>
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo" href="{{Route('home')}}"><img src="{{asset('/assets/images/logo/Logo_LT_(purple).svg')}}" alt="logo" /></a>
          <a class="navbar-brand brand-logo-mini" href="{{Route('home')}}"><img src="{{asset('/assets/images/logo/Single_L_(purple).svg')}}" alt="logo" /></a>
        </div>
